...
import { apiRequest, apiRequestWithoutRetry, queryClient, setAuthBridge } from "./query-client";
...
function LoadingScreen() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-background" data-testid="state-auth-loading">
