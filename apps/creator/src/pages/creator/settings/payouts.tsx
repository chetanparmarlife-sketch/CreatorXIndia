...
export default function SettingsPayoutsPage() {
  ...
  const upiMut = useMutation({
    ...
    onError: (e: unknown) => toast({ title: "Couldn't save UPI", description: getErrorMessage(e), variant: "destructive" }),
  });
  ...
  const bankMut = useMutation({
    ...
    onError: (e: unknown) => toast({ title: "Couldn't save bank", description: getErrorMessage(e), variant: "destructive" }),
  });
