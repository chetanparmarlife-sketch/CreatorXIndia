...
export default function CampaignApplicationsPage() {
  ...
  const [brandMatched, brandParams] = useRoute<{ id: string }>("/campaigns/:id/applications");
  const [adminMatched, adminParams] = useRoute<{ brandId: string; id: string }>("/brands/:brandId/campaigns/:id/applications");
              ...
              >
                <div className="flex flex-wrap items-start justify-between gap-4">
                  ...
                  <div className="flex flex-col items-end gap-2">
                    ...
                    <Link
                      href={`/creators/${application.creator_id}`}
