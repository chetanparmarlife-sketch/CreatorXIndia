  ...
  return (
    <AdminShell title="Overview" subtitle="Platform-wide CreatorX health">
      <div className="mb-6 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <KpiCard label="Total Brands" value={fmtCompact(data.totalBrands)} testId="kpi-total-brands" href={financeOnly ? undefined : "/brands"} />
        <KpiCard label="Active Campaigns" value={fmtCompact(data.activeCampaigns)} testId="kpi-active-campaigns" href={financeOnly ? undefined : "/campaigns"} />
        <KpiCard label="Total Creators" value={fmtCompact(data.totalCreators)} testId="kpi-total-creators" href={financeOnly ? undefined : "/creators"} />
        <KpiCard label="Platform Revenue" value={fmtMoney(data.platformRevenuePaise, { compact: true })} testId="kpi-platform-revenue" href="/payouts" />
      </div>
