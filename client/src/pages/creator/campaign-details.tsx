...
import type { Campaign, Brand, Application, Deliverable } from "@shared/schema";
...
export default function CampaignDetailsPage() {
  ...
  const markLiveMut = useMutation({
    ...
    onError: (e: any) => toast({ title: "Couldn't mark live", description: e?.message, variant: "destructive" }),
  });
  ...
  const applyMut = useMutation({
    ...
    onError: (e: any) => {
      toast({ title: "Couldn't apply", description: e?.message || "Please try again.", variant: "destructive" });
    },
  });
