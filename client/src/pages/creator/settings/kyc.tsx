...
import { isValidPAN, isValidGSTIN, isValidAadhaarLast4 } from "@shared/india";
...
export default function SettingsKycPage() {
  ...
  const kycMut = useMutation({
    ...
    onError: (e: any) =>
      toast({ title: "KYC failed", description: e?.message || "Please check your details.", variant: "destructive" }),
  });
